...
public class ITetrominoSoftbody : MonoBehaviour, ISoftbody
{
    ...
    public void InitRayDetectors()
    {
        ...
        RayDetector1.transform.position = SpringCubeManager.FindMidpoint(VertexA1, VertexG2);
        ...
        RayDetector2.transform.position = SpringCubeManager.FindMidpoint(VertexB1, VertexH2);
        ...
        RayDetector3.transform.position = SpringCubeManager.FindMidpoint(VertexC1, VertexI2);
        ...
        RayDetector4.transform.position = SpringCubeManager.FindMidpoint(VertexD1, VertexJ2);
    }
    ...
    public void GenerateCubeOne()
    {
        ...
        // Generate Front Face
        SpringCubeManager.GenerateFace(ref VertexA1, ref VertexB1, ref VertexF1, ref VertexG1);
        // Generate Back Face
        SpringCubeManager.GenerateFace(ref VertexA2, ref VertexB2, ref VertexF2, ref VertexG2);
        // Generate Left Face
        SpringCubeManager.GenerateFace(ref VertexA1, ref VertexA2, ref VertexF1, ref VertexF2);

        SpringCubeManager.ConnectVertices(ref RayDetector1, ref VertexA1, ref VertexB1, ref VertexF1, ref VertexG1, ref VertexA2, ref VertexB2,ref VertexF2, ref VertexG2);
    }
    ...
    public void GenerateCubeTwo()
    {
        ...
        // Generate Front Face
        SpringCubeManager.GenerateFace(ref VertexB1, ref VertexC1, ref VertexG1, ref VertexH1);
        // Generate Back Face
        SpringCubeManager.GenerateFace(ref VertexB2, ref VertexC2, ref VertexG2, ref VertexH2);
        // Generate Left Face
        SpringCubeManager.GenerateFace(ref VertexB1, ref VertexB2, ref VertexG1, ref VertexG2);

        SpringCubeManager.ConnectVertices(ref RayDetector2, ref VertexB1, ref VertexC1, ref VertexG1, ref VertexH1, ref VertexB2, ref VertexC2,ref VertexG2, ref VertexH2);
    }
    ...
    public void GenerateCubeThree()
    {
        ...
        // Generate Front Face
        SpringCubeManager.GenerateFace(ref VertexC1, ref VertexD1, ref VertexH1, ref VertexI1);
        // Generate Back Face
        SpringCubeManager.GenerateFace(ref VertexC2, ref VertexD2, ref VertexH2, ref VertexI2);
        // Generate Left Face
        SpringCubeManager.GenerateFace(ref VertexC1, ref VertexC2, ref VertexH1, ref VertexH2);

        SpringCubeManager.ConnectVertices(ref RayDetector3, ref VertexC1, ref VertexD1, ref VertexH1, ref VertexI1, ref VertexC2, ref VertexD2,ref VertexH2, ref VertexI2);
    }
    ...
    public void GenerateCubeFour()
    {
        ...
        // Generate Front Face
        SpringCubeManager.GenerateFace(ref VertexD1, ref VertexE1, ref VertexI1, ref VertexJ1);
        // Generate Back Face
        SpringCubeManager.GenerateFace(ref VertexD2, ref VertexE2, ref VertexI2, ref VertexJ2);
        // Generate Left Face
        SpringCubeManager.GenerateFace(ref VertexD1, ref VertexD2, ref VertexI1, ref VertexI2);
        // Generate Right Face
        SpringCubeManager.GenerateFace(ref VertexE1, ref VertexE2, ref VertexJ1, ref VertexJ2);

        SpringCubeManager.ConnectVertices(ref RayDetector4, ref VertexD1, ref VertexE1, ref VertexI1, ref VertexJ1, ref VertexD2, ref VertexE2,ref VertexI2, ref VertexJ2);
    }
