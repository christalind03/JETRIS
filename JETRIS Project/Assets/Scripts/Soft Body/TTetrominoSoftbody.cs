...
public class TTetrominoSoftbody : MonoBehaviour, ISoftbody
{
...
/// <summary>
    ...
    public void InitRayDetectors()
    {
        ...
        RayDetector2.transform.position = SpringCubeManager.FindMidpoint(VertexC1, VertexH2);
    ...
    public void GenerateCubeTwo()
    {
        ...
        // Generate Front Face
        SpringCubeManager.GenerateFace(ref VertexC1, ref VertexD1, ref VertexG1, ref VertexH1);
        // Generate Back Face
        SpringCubeManager.GenerateFace(ref VertexC2, ref VertexD2, ref VertexG2, ref VertexH2);
        // Generate Left Face
        SpringCubeManager.GenerateFace(ref VertexC1, ref VertexC2, ref VertexG1, ref VertexG2);

        SpringCubeManager.ConnectVertices(ref RayDetector2, ref VertexC1, ref VertexD1, ref VertexG1, ref VertexH1, ref VertexC2, ref VertexD2,ref VertexG2, ref VertexH2);
    }
